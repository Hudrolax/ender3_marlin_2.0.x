...
#define HOMING_BUMP_DIVISOR { 6, 6, 32 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 10*60, 5*60 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define MIN_PROBE_EDGE_BACK MIN_PROBE_EDGE + 20 
#endif
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       610        // (mA) RMS current. Multiply by 1.414 for peak current.
